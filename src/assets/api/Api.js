...
export default {
    ...
    assetsEntry:{  //资产管理增删改查接口
        list: ['/depart_inventory/selectList', 'post'], 
        insert: ['/departMaterialManage/insert', 'post'], 
        delete: ['/departMaterialManage/delete', 'post'],  
        update: ['/departMaterialManage/update', 'post'],
        trans: ['autoAssignMaterialSituation','post'],       //资产调配接口
        getDept: ['/depart_inventory/selectDepart','get'],       //获取部门list
        getDeptAssets: ['/depart_inventory/selectMaterial','post'],    //根据部门id获取部门下资产
        inventoryAsset: ['/depart_inventory/inventoryAsset','post'], //资产盘点
        //智能调配
        selectInventoryNum: ['/depart_inventory/allotSelect','post'], //查询调配单列表
        insertList: ['/depart_inventory/schemeSave','post'],  //新增智能调配单
        scheme: ['/depart_inventory/scheme','post'],  //查询部门/仓库可提供数量
        selectDepartNum: ['/depart_inventory/selectDepartNum','post'],  //智能调配工具闲置查询(部门)
        updateList: ['/depart_inventory/list_condition','post'],  //编辑审核
    },
    databaseBackups:{//数据库备份
        backups:['/database','get'],
        sync:['/database','post'],
        backupsDepartInventory:['/database/departInventory','get'],
        syncDepartInventory:['/database/departInventory','post']
    }
}